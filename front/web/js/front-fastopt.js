...
/** @constructor */
function $c_Lutil_CommonConst$DefaultAuth$() {
  $c_O.call(this);
  this.authValue$1 = null
}
$c_Lutil_CommonConst$DefaultAuth$.prototype = new $h_O();
$c_Lutil_CommonConst$DefaultAuth$.prototype.constructor = $c_Lutil_CommonConst$DefaultAuth$;
/** @constructor */
function $h_Lutil_CommonConst$DefaultAuth$() {
  /*<skip>*/
}
$h_Lutil_CommonConst$DefaultAuth$.prototype = $c_Lutil_CommonConst$DefaultAuth$.prototype;
$c_Lutil_CommonConst$DefaultAuth$.prototype.init___ = (function() {
  this.authValue$1 = "qazwsxedc";
  return this
});
var $d_Lutil_CommonConst$DefaultAuth$ = new $TypeData().initClass({
  Lutil_CommonConst$DefaultAuth$: 0
}, false, "util.CommonConst$DefaultAuth$", {
  Lutil_CommonConst$DefaultAuth$: 1,
  O: 1
});
$c_Lutil_CommonConst$DefaultAuth$.prototype.$classData = $d_Lutil_CommonConst$DefaultAuth$;
var $n_Lutil_CommonConst$DefaultAuth$ = (void 0);
function $m_Lutil_CommonConst$DefaultAuth$() {
  if ((!$n_Lutil_CommonConst$DefaultAuth$)) {
    $n_Lutil_CommonConst$DefaultAuth$ = new $c_Lutil_CommonConst$DefaultAuth$().init___()
  };
  return $n_Lutil_CommonConst$DefaultAuth$
}
function $f_Lutil_LoginSupport__setAuth__s_Option__V($thiz, authOption) {
  if ($is_s_Some(authOption)) {
    ...
    var x = $m_s_None$();
    if ((x === authOption)) {
      $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().localStorage.setItem($m_Lutil_CommonConst$().authHead$1, $m_Lutil_CommonConst$DefaultAuth$().authValue$1)
    } else {
...
$c_Lnathan_MainApp$.prototype.$$js$exported$meth$init__O = (function() {
  var authOption = $m_s_None$();
  $f_Lutil_LoginSupport__setAuth__s_Option__V(this, authOption)
});
...
$c_Lnathan_MainApp$.prototype.init = (function() {
...
var $d_Lnathan_MainApp$ = new $TypeData().initClass({
  ...
  Lnathan_MainApp$: 1,
  O: 1,
  Lservice_user_AgentService: 1,
  Lutil_LoginSupport: 1,
